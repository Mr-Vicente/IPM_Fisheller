...
class MapState extends State<Map> {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            fit: BoxFit.fill,
                            image: Image.asset("assets/images/fish_market.png")
                                .image,
                          ),
                        ),
                      ),
  ...
  void filterMarkers(FilterModel fm) {
    ...
    print(' *************************' +
        ...
        fm.seafood +
        '\nPrice min: ' +
        fm.minPrice.toString() +
        '\nPrice max: ' +
        fm.maxPrice.toString() +
        '\nQuantity min: ' +
        fm.minQuantity.toString() +
        '\nQuantity max: ' +
        fm.maxQuantity.toString());
    markets.forEach((m) {
      print(' *************************\n' + m.name);
      for (Sell i in m.items) {
        ...
        if (fm.seafood != '' &&
            s.type != null &&
            s.type.name.toLowerCase().trim() !=
                fm.seafood.toLowerCase().trim()) {
          addMarket = false;
          print('2');
        }
